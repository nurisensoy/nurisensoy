...
Şeffaflık Platformu Web Servis Hizmetini ve [şeffaflık python kütüphanesi](https://nurisensoy.github.io/nurisensoy/seffaflik_platformu/seffaflik_kutuphanesi) 
...
adımları takip ederek **istemci tanıtıcılarını (client id)** temin etmelidirler. Sonrasında ise kullanıcılar istemci
 ...
 [şeffaflık python kütüphanesinden](https://nurisensoy.github.io/nurisensoy/seffaflik_platformu/seffaflik_kutuphanesi) de faydanalabileceklerir.
